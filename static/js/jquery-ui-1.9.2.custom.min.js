...
(function (e, t) {
    function i(t, n) {
        ...
        return "area" === u ? (r = t.parentNode, i = r.name, !t.href || !i || r.nodeName.toLowerCase() !== "map" ? !1 : (o = e("images[usemap=#" + i + "]")[0], !!o && s(o))) : (/input|select|textarea|button|object/.test(u) ? !t.disabled : "a" === u ? t.href || n : n) && s(t)
    }
    ...
    $.extend(Datepicker.prototype, {
        ...
        _attachments: function (e, t) {
            ...
            if (i == "button" || i == "both") {
                ...
                t.trigger = $(this._get(t, "buttonImageOnly") ? $("<images/>").addClass(this._triggerClass).attr({
                    src: o,
                    alt: s,
                    title: s
                }) : $('<button type="button"></button>').addClass(this._triggerClass).html(o == "" ? s : $("<images/>").attr({
                    src: o,
                    alt: s,
                    title: s
